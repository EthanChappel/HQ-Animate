...
class Ui_MainFrame(object):
    def setupUi(self, MainFrame):
        ...
        QWidget.setTabOrder(self.duration_spinbox, self.width_spinner)
        QWidget.setTabOrder(self.width_spinner, self.height_spinner)
        QWidget.setTabOrder(self.height_spinner, self.loop_spinner)
        ...
        QWidget.setTabOrder(self.convert_button, self.apng_back_button)
        ...
        QWidget.setTabOrder(self.avif_quality_spinner, self.webp_quality_spinner)
        QWidget.setTabOrder(self.webp_quality_spinner, self.gif_back_button)
        QWidget.setTabOrder(self.gif_back_button, self.webp_lossless_check)
        QWidget.setTabOrder(self.webp_lossless_check, self.avif_back_button)
        QWidget.setTabOrder(self.avif_back_button, self.mp4_back_button)
        QWidget.setTabOrder(self.mp4_back_button, self.gif_optimize_check)
        QWidget.setTabOrder(self.gif_optimize_check, self.mp4_codec_combo)
        QWidget.setTabOrder(self.mp4_codec_combo, self.next_frame_button)
        QWidget.setTabOrder(self.next_frame_button, self.frames_slider)
        QWidget.setTabOrder(self.frames_slider, self.webm_codec_combo)
        QWidget.setTabOrder(self.webm_codec_combo, self.mp4_quality_spinner)
        QWidget.setTabOrder(self.mp4_quality_spinner, self.webm_quality_spinner)
        QWidget.setTabOrder(self.webm_quality_spinner, self.webm_back_button)
